...
class ComentariosControllerTest < ActionController::TestCase
  ...
  test "should create comentario" do
    assert_difference('Comentario.count') do
      post :create, comentario: { descricao: @comentario.descricao, nome: @comentario.nome, titulo: @comentario.titulo }
    end
  ...
  test "should update comentario" do
    patch :update, id: @comentario, comentario: { descricao: @comentario.descricao, nome: @comentario.nome, titulo: @comentario.titulo }
    assert_redirected_to comentario_path(assigns(:comentario))
  end
